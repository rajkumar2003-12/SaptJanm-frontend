...
export function Profile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${BACKEND_URL}/profile/create`, validationResult.data, { 
        headers: {
    ...
    <div className="flex flex-col min-h-screen pt-16">
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="bg-white shadow-lg rounded-lg p-8 max-w-4xl w-full">
          <h1 className="text-2xl font-bold mb-8 text-black text-center underline decoration-4">Profile Form</h1>
          <form
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className={`mt-6 w-full p-3 ${loading ? "bg-gray-600" : "bg-blue-600"} text-white rounded-full hover:bg-gray-800 transition`}
            >
